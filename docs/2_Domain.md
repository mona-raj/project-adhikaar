...
The initial list of required Services is inferred from the Help Request using rule-based or AI-assisted analysis. Before organization recommendations are generated, the Help Seeker may review and modify this list. The Case always stores the currently confirmed service requirements.
...
C[Review Required Services]
D[Review Recommendations]
E[Approve Recommendations]
...
I[Validate Request]
J[Create Case]
K[Infer Required Services]
K1[Review & Confirm Services]
